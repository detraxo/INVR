...
{
    public class SpeechToTextAndroid : MonoBehaviour
    {

        #region Init
        static SpeechToTextAndroid _instance;
        public static SpeechToTextAndroid instance
        {
            get
            {
                if (_instance == null)
        ...
        public static void Init()
        {
            ...
            _instance = obj.AddComponent<SpeechToTextAndroid>();
        }
        void Awake()
        {
            _instance = this;
