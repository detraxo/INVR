...
{
    public class TextToSpeechAndroid : MonoBehaviour
    {
        #region Init
        static TextToSpeechAndroid _instance;
        public static TextToSpeechAndroid instance
        {
            get
            {
                if (_instance == null)
        ...
        public static void Init()
        {
            ...
            _instance = obj.AddComponent<TextToSpeechAndroid>();
        }
        void Awake()
        {
            _instance = this;
